...
730 :
740 DEF PROCtext
750 REM Optional Space Invader (CHR$230)
760 VDU23,230,60,126,219,126,36,66,129,0
770 REM Table of Styles
780 REM  =========================
790 REM | Style | Lines | Letters |
800 REM |   1   |   3   |   13    |
810 REM |   2   |   3   |    6    |
820 REM |   3   |   2   |   13    |
830 REM |   4   |   2   |    6    |
...
970 ON ERROR OFF
980 MODE 7
990 IF ERR<>17 THEN REPORT:PRINT " at line ";ERL
1000 END
